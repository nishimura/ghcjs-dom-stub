...
js_hasAttributes ::
         Element -> IO Bool
js_hasAttributes _ = return False
...
js_getAttributeNames :: Element -> IO JSVal
js_getAttributeNames _ = return jsNull
...
js_getAttribute :: Element -> JSString -> IO (Nullable JSString)
js_getAttribute _ _ = return (Nullable jsNull)
...
js_getAttributeNS ::
         Element -> Optional JSString -> JSString -> IO (Nullable JSString)
js_getAttributeNS _ _ _ = return (Nullable jsNull)
...
js_setAttributeNS ::
         Element -> Optional JSString -> JSString -> JSString -> IO ()
js_setAttributeNS _ _ _ _ = return ()
...
js_removeAttributeNS ::
         Element -> Optional JSString -> JSString -> IO ()
js_removeAttributeNS _ _ _ = return ()
...
js_hasAttribute ::
         Element -> JSString -> IO Bool
js_hasAttribute _ _ = return False
...
js_hasAttributeNS ::
         Element -> Optional JSString -> JSString -> IO Bool
js_hasAttributeNS _ _ _ = return False
...
js_getAttributeNode :: Element -> JSString -> IO (Nullable Attr)
js_getAttributeNode _ _ = return (Nullable jsNull)
...
js_getAttributeNodeNS ::
         Element -> Optional JSString -> JSString -> IO (Nullable Attr)
js_getAttributeNodeNS _ _ _ = return (Nullable jsNull)
...
js_setAttributeNode :: Element -> Attr -> IO (Nullable Attr)
js_setAttributeNode _ _ = return (Nullable jsNull)
...
js_setAttributeNodeNS :: Element -> Attr -> IO (Nullable Attr)
js_setAttributeNodeNS _ _ = return (Nullable jsNull)
...
js_removeAttributeNode :: Element -> Attr -> IO Attr
js_removeAttributeNode _ _ = return (Attr jsNull)
...
js_attachShadow :: Element -> ShadowRootInit -> IO ShadowRoot
js_attachShadow _ _ = return (ShadowRoot jsNull)
...
js_closest ::
         Element -> JSString -> IO (Nullable Element)
js_closest _ _ = return (Nullable jsNull)
...
js_webkitMatchesSelector :: Element -> JSString -> IO Bool
js_webkitMatchesSelector _ _ = return False
...
js_insertAdjacentElement
         :: Element -> JSString -> Element -> IO (Nullable Element)
js_insertAdjacentElement _ _ _ = return (Nullable jsNull)
...
js_insertAdjacentText :: Element -> JSString -> JSString -> IO ()
js_insertAdjacentText _ _ _ = return ()
...
js_getClientRects :: Element -> IO JSVal
js_getClientRects _ = return jsNull
...
js_getBoundingClientRect :: Element -> IO DOMRect
js_getBoundingClientRect _ = return (DOMRect jsNull)
...
js_insertAdjacentHTML :: Element -> JSString -> JSString -> IO ()
js_insertAdjacentHTML _ _ _ = return ()
...
--         Element -> IO ()
js_webkitRequestFullScreen ::
         Element -> IO ()
js_webkitRequestFullScreen _ = return ()
...
js_requestPointerLock :: Element -> IO ()
js_requestPointerLock _ = return ()
...
js_webkitGetRegionFlowRanges
         :: Element -> IO JSVal
js_webkitGetRegionFlowRanges _ = return jsNull
...
--         Element -> Bool -> IO ()
js_scrollIntoViewIfNeeded ::
         Element -> Bool -> IO ()
js_scrollIntoViewIfNeeded _ _ = return ()
...
js_getNamespaceURI :: Element -> IO (Nullable JSString)
js_getNamespaceURI _ = return (Nullable jsNull)
...
js_getPrefix ::
         Element -> IO (Nullable JSString)
js_getPrefix _ = return (Nullable jsNull)
...
js_getLocalName :: Element -> IO JSString
js_getLocalName _ = return JSString.empty
...
js_getTagName ::
         Element -> IO JSString
js_getTagName _ = return JSString.empty
...
js_getId ::
         Element -> IO JSString
js_getId _ = return JSString.empty
...
js_getClassName :: Element -> IO JSString
js_getClassName _ = return JSString.empty
...
js_getClassList :: Element -> IO DOMTokenList
js_getClassList _ = return (DOMTokenList jsNull)
...
js_getSlot ::
         Element -> IO JSString
js_getSlot _ = return JSString.empty
...
js_getAttributes :: Element -> IO NamedNodeMap
js_getAttributes _ = return (NamedNodeMap jsNull)
...
js_getShadowRoot :: Element -> IO (Nullable ShadowRoot)
js_getShadowRoot _ = return (Nullable jsNull)
...
js_getInnerHTML :: Element -> IO JSString
js_getInnerHTML _ = return JSString.empty
...
js_getOuterHTML :: Element -> IO JSString
js_getOuterHTML _ = return JSString.empty
...
js_getWebkitRegionOverset :: Element -> IO JSString
js_getWebkitRegionOverset _ = return JSString.empty
