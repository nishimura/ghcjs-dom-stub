...
js_getRootNode :: Node -> Optional GetRootNodeOptions -> IO Node
js_getRootNode _ _ = return (Node jsNull)
...
js_hasChildNodes ::
         Node -> IO Bool
js_hasChildNodes _ = return False
...
js_cloneNode
         :: Node -> Bool -> IO Node
js_cloneNode _ _ = return (Node jsNull)
...
js_isEqualNode ::
         Node -> Optional Node -> IO Bool
js_isEqualNode _ _ = return False
...
js_isSameNode :: Node -> Optional Node -> IO Bool
js_isSameNode _ _ = return False
...
--         Node -> Node -> IO Word
js_compareDocumentPosition ::
         Node -> Node -> IO Word
js_compareDocumentPosition _ _ = return 0
...
js_lookupPrefix ::
         Node -> Optional JSString -> IO (Nullable JSString)
js_lookupPrefix _ _ = return (Nullable jsNull)
...
js_lookupNamespaceURI ::
         Node -> Optional JSString -> IO (Nullable JSString)
js_lookupNamespaceURI _ _ = return (Nullable jsNull)
...
js_isDefaultNamespace ::
         Node -> Optional JSString -> IO Bool
js_isDefaultNamespace _ _ = return False
...
js_insertBefore :: Node -> Node -> Optional Node -> IO Node
js_insertBefore _ _ _ = return (Node jsNull)
...
js_appendChild :: Node -> Node -> IO Node
js_appendChild _ _ = return (Node jsNull)
...
js_replaceChild :: Node -> Node -> Node -> IO Node
js_replaceChild _ _ _ = return (Node jsNull)
...
js_removeChild :: Node -> Node -> IO Node
js_removeChild _ _ = return (Node jsNull)
...
js_getNodeName
         :: Node -> IO JSString
js_getNodeName _ = return JSString.empty
...
js_getBaseURI ::
         Node -> IO JSString
js_getBaseURI _ = return JSString.empty
...
js_getIsConnected :: Node -> IO Bool
js_getIsConnected _ = return False
...
js_getOwnerDocument :: Node -> IO (Nullable Document)
js_getOwnerDocument _ = return (Nullable jsNull)
...
js_getParentNode :: Node -> IO (Nullable Node)
js_getParentNode _ = return (Nullable jsNull)
...
js_getParentElement :: Node -> IO (Nullable Element)
js_getParentElement _ = return (Nullable jsNull)
...
js_getChildNodes :: Node -> IO NodeList
js_getChildNodes _ = return (NodeList jsNull)
...
js_getFirstChild :: Node -> IO (Nullable Node)
js_getFirstChild _ = return (Nullable jsNull)
...
js_getLastChild :: Node -> IO (Nullable Node)
js_getLastChild _ = return (Nullable jsNull)
...
js_getPreviousSibling :: Node -> IO (Nullable Node)
js_getPreviousSibling _ = return (Nullable jsNull)
...
js_getNextSibling :: Node -> IO (Nullable Node)
js_getNextSibling _ = return (Nullable jsNull)
...
js_getNodeValue :: Node -> IO (Nullable JSString)
js_getNodeValue _ = return (Nullable jsNull)
...
js_getTextContent :: Node -> IO (Nullable JSString)
js_getTextContent _ = return (Nullable jsNull)
